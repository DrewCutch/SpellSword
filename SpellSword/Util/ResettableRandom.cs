...
{
    //From https://stackoverflow.com/a/46241672/10184960
    public sealed class ResettableRandom: IGenerator
    {
        ...
        public ResettableRandom(int[] saveState)
        {
            LoadState(saveState);
        }

        public ResettableRandom(int seed)
        {
            Seed = (uint) seed;
        }
        ...
        public bool Reset()
        {
            Reseed(Convert.ToInt32(this.Seed));

            // returns true to satisfy interface
            return true;
        }
        ...
        {
            return NextInteger(int.MinValue, int.MaxValue);
        }
        ...
        public void LoadState(int[] saveState)
        {
            ...
            {
                throw new Exception("ResetableRandom state was corrupted!");
            }
